...
def plot_speedup_chart(df, complexities, title="Speedup Comparison"):
    ...
    plt.savefig(os.path.join(RESULT_DIR, "speedup_comparison_bvh.png"), dpi=300)
    plt.clf()


if __name__ == "__main__":
    # Filename from command line argument
    data_file = "data/bvh-scene-complexity.csv"  # Update this to your actual parsed CSV file path
