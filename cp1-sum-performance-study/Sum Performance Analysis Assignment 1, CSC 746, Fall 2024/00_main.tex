...
\title{Sum Performance Analysis \\Assignment \#1, CSC 746, Fall 2024}
...
\afterpage{\clearpage} % Forces all pending floats to be output and starts a new page

%% if specified like this the section will be committed in review mode
\acknowledgments{
This paper was edited with the assistance of ChatGPT-4o (accessed September 2024), primarily for correcting grammatical errors and rephrasing. This research used resources from the National Energy Research Scientific Computing Center (NERSC), a Department of Energy Office of Science User Facility using NERSC award DDR-ERCAP m3930 for 2024.
}
