...
% 8/2021, w. bethel
% the contents of this file is a cut-n-paste from the "main" of the IEEE
% TVCG Conference Style Template provided on overleaf. I'm leaving this
% material here so that you can use it for examples if you like.
%
