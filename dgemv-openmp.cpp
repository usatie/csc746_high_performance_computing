...
#pragma omp parallel
  ...
  // insert your dgemv code here. you may need to create additional parallel
  // regions, and you will want to comment out the above parallel code block
  // that prints out nthreads and thread_id so as to not taint your timings
}
